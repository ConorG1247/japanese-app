...
import {
  beginnerKatakanaOptions,
  beginnerKatakanaAnswer,
} from "../../../libs/data";
...
function Katakana() {
  ...
  return (
    <div className="hiragana">
      <Navbar />
      <div className="selection-title">Katakana</div>
      <div className="hiragana-container">
        ...
        {typeSelect === 1 && (
          <FlashCards
            langOptions={beginnerKatakanaOptions}
            langAnswer={beginnerKatakanaAnswer}
          />
        )}
        {typeSelect === 2 && (
          <TypingTest
