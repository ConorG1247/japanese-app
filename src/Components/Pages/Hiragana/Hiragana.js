...
import {
  beginnerHiraganaAnswer,
  beginnerHiraganaOptions,
} from "../../../libs/data";
...
function Hiragana() {
  ...
  return (
    <div className="hiragana">
      <Navbar />
      <div className="selection-title">Hiragana</div>
      <div className="hiragana-container">
        ...
        {typeSelect === 1 && (
          <FlashCards
            langOptions={beginnerHiraganaOptions}
            langAnswer={beginnerHiraganaAnswer}
          />
        )}
        {typeSelect === 2 && (
          <TypingTest
